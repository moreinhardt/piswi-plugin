			...
			xmlHttpObject.onreadystatechange = function (aEvt) {  
				if (xmlHttpObject.readyState == 4) {  
					if(xmlHttpObject.status == 200) { //logged in
						...
						if (document.getElementById('lehrveranstaltungen_tab').selected == true){
						...
						if (document.getElementById('prufungen_tab').selected == true) {	
						xmlHttpObject.open('GET', 'http://sibelius.pri.univie.ac.at:8885/piswi/xxx/piswi.x?isid='+isid+'1&imod=P'); // send to display lvs /1 added after isid
						xmlHttpObject.setRequestHeader('Connection','keep-alive');
						xmlHttpObject.setRequestHeader('imnr',matnr);
						xmlHttpObject.setRequestHeader('ikenn',kennwort);
						xmlHttpObject.setRequestHeader('Referer','http://sibelius.pri.univie.ac.at:8885/piswi/xxx/piswi.x');
						...
						xmlHttpObject.onreadystatechange = function(cEvt) {
							if(xmlHttpObject.readyState == 4) {
								if(xmlHttpObject.status == 200) { //displaying lvs
									//one deeper
									xmlHttpObject.open('GET', 'http://sibelius.pri.univie.ac.at:8885/piswi/xxx/piswi.x?isid='+isid+'2&imod=J'); // send to display actual results of lvs /2 added after isid
									xmlHttpObject.setRequestHeader('Connection','keep-alive');
									xmlHttpObject.setRequestHeader('imnr',matnr);
									xmlHttpObject.setRequestHeader('ikenn',kennwort);
									xmlHttpObject.setRequestHeader('Referer','http://sibelius.pri.univie.ac.at:8885/piswi/xxx/piswi.x?isid='+isid+'1&imod=P');
									xmlHttpObject.send(null);
									xmlHttpObject.onreadystatechange = function(dEvt) {
										if(xmlHttpObject.readyState == 4) {
											if(xmlHttpObject.status == 200) { //displaying lvs with actual results
												...
												xmlHttpObject.open('POST', 'http://sibelius.pri.univie.ac.at:8885/piswi/xxx/piswi.x');
												xmlHttpObject.setRequestHeader('Connection','keep-alive');
												xmlHttpObject.setRequestHeader('Referer','http://sibelius.pri.univie.ac.at:8885/piswi/xxx/piswi.x?isid='+isid+'2&imod=J');
												xmlHttpObject.setRequestHeader('imnr',matnr);
												xmlHttpObject.setRequestHeader('ikenn',kennwort);
												xmlHttpObject.setRequestHeader('Content-Type','application/x-www-form-urlencoded');
												xmlHttpObject.setRequestHeader('Content-Length', 94);
